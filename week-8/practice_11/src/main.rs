fn main() {
    ...
    // create a slice of 2d and 3rd element
    let slice1 = &numbers[1..3];
    println!("2nd and 3rd elements sliced = {:?}",slice1);

    // omit the start index
    let slice2 = &numbers[..3];
    // This means the slice starts from index 0 and goes up to index 3 (exclusve)
    ...
    let slice4 = &numbers[..];
    // This means the slice starts from 0 and goes up to index 5 (exclusive)
